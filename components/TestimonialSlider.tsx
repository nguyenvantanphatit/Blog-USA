...
const testimonials = [
  {
    name: 'Nguyễn Văn A',
    comment: 'Sản phẩm chất lượng, giao hàng nhanh. Rất hài lòng với dịch vụ!',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Trần Thị B',
    comment: 'Đồ trang trí Tết đẹp, giá cả hợp lý. Chắc chắn sẽ mua lại.',
    avatar: 'https://avatars.githubusercontent.com/u/20110627',
  },
  {
    name: 'Lê Văn C',
    comment: 'Quà tặng Tết ý nghĩa, người nhận rất thích. Cảm ơn Tết Việt!',
    avatar: 'https://avatars.githubusercontent.com/u/20110627',
  },
  {
    name: 'Anh Minh',
    comment: 'Sản phẩm rất chất lượng, giá cả hợp lý. Dịch vụ tư vấn chu đáo và giao hàng nhanh chóng. Rất đáng tin cậy!',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Chị Thảo',
    comment: 'Tôi rất ấn tượng với cách đóng gói sản phẩm, rất cẩn thận. Dịch vụ hỗ trợ cũng cực kỳ nhiệt tình.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Anh Nam',
    comment: 'Mua lần đầu mà cực kỳ hài lòng. Sản phẩm y như mô tả, nhân viên rất chuyên nghiệp. Sẽ quay lại lần sau.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Chị Linh',
    comment: 'Không chỉ sản phẩm tốt mà cách chăm sóc khách hàng của các bạn khiến tôi cảm thấy rất thoải mái và yên tâm.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Anh Tuấn',
    comment: 'Giao hàng đúng hẹn, hàng chất lượng cao. Rất đáng để giới thiệu cho bạn bè.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Chị Mai',
    comment: 'Mình đã thử mua nhiều nơi nhưng chưa thấy nơi nào phục vụ tốt như ở đây. Đặc biệt là đội ngũ tư vấn rất tận tình.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Anh Hùng',
    comment: 'Rất hài lòng với chính sách đổi trả. Các bạn hỗ trợ rất nhanh và dễ dàng. Cảm ơn nhiều!',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Chị Vy',
    comment: 'Sản phẩm thực sự đẹp hơn cả hình ảnh trên web. Rất bất ngờ với chất lượng.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Anh Phong',
    comment: 'Mua hàng online nhưng cảm giác như đang mua trực tiếp vì dịch vụ chăm sóc khách hàng rất tốt.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
  {
    name: 'Chị Ngọc',
    comment: 'Đội ngũ làm việc chuyên nghiệp, từ giao hàng đến tư vấn đều rất chu đáo. Tôi sẽ tiếp tục ủng hộ.',
    avatar: 'https://avatars.githubusercontent.com/u/16860528',
  },
];
  ...
  return (
    ...
    >
      ...
      <div  className={cn(
        ...
        // light styles
        "border-gray-950/[.1] bg-white hover:bg-white/[.05]",
      )}>
        <div className="relative">
          <figure className="relative z-10 flex flex-col items-center">
            <blockquote className="mt-2 text-sm">{comment}</blockquote>
            <figcaption className="flex items-center gap-4 pt-2 text-sm text-left text-black">
              <img
              ...
              />
              <div className="flex flex-col justify-center gap-1 mx-auto">
...
export default function TestimonialSlider() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-white md:shadow-xl">
